        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-actions">
                    <?php if (is_logged_in()): ?>
                        <a href="<?php echo BASE_URL; ?>/view/user/dashboard.php" class="btn btn-primary btn-lg">
                            <i class="fas fa-tachometer-alt"></i> Go to Dashboard
                        </a>
                        <a href="<?php echo BASE_URL; ?>/view/product/product_list.php" class="btn btn-outline btn-lg">
                            <i class="fas fa-shopping-bag"></i> Browse Products
                        </a>
                    <?php else: ?>
                        <a href="<?php echo BASE_URL; ?>/view/user/register.php" class="btn btn-primary btn-lg">
                            <i class="fas fa-user-plus"></i> Create Account
                        </a>
                        <a href="<?php echo BASE_URL; ?>/view/user/login.php" class="btn btn-outline btn-lg">
