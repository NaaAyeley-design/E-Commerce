...
<div class="auth-container forgot-container">
    <!-- Back to Login Link -->
    <a href="<?php echo BASE_URL; ?>/view/user/login.php" class="back-home">
    ...
    <form id="forgotForm" class="ajax-form" method="post" action="<?php echo BASE_URL; ?>/actions/forgot_password_action.php">
