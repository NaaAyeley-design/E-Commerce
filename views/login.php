...
<body>
    ...
    <div class="login-container">
        ...
        <form id="loginForm" method="post" action="/ecommerce-authent/actions/login_customer_action.php">
            ...
            <div class="remember-section">
                ...
                <a href="/ecommerce-authent/views/forgot_password.php" class="forgot-link">Forgot password?</a>
            </div>
        ...
        <div class="auth-links">
            <p>Don't have an account? <a href="/ecommerce-authent/views/register.php">Create one here</a></p>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch('/ecommerce-authent/actions/login_customer_action.php', {
                    method: 'POST',
                    body: formData
                })
                ...
                .then(data => {
                    ...
                    if (data === 'success') {
                        ...
                        setTimeout(() => {
                            window.location.href = '/ecommerce-authent/views/dashboard.php';
                        }, 2000);
                    } else {
