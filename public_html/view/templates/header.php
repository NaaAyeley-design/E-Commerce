...
<head>
    ...
    <!-- Google Fonts - Refined Minimal Design -->
                        ...
                        <?php if (!is_admin()): ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php if ($is_customer): ?>
                                    ...
                                    <li class="top-navbar-item">
                                        <a href="<?php echo url('view/user/dashboard.php?section=wishlist'); ?>" class="top-navbar-link wishlist-link" aria-label="Wishlist">
