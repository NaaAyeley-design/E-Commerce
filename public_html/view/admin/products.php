...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/products.css">
</head>
<body>
    <!-- Navigation -->
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="<?php echo BASE_URL; ?>/view/admin/brands.php" class="nav-link">Brands</a></li>
                <li><a href="<?php echo BASE_URL; ?>/view/admin/products.php" class="nav-link active">Products</a></li>
