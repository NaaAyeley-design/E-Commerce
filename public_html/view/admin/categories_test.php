<?php
/**
 * Category Management Page - Test Version
    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'add':
                ...
                if (!empty($cat_name)) {
                    $message = "Category '$cat_name' would be added successfully! (Test mode)";
                } else {
            ...
            case 'delete':
                ...
                if ($cat_id > 0) {
                    $message = "Category ID $cat_id would be deleted successfully! (Test mode)";
                } else {
            ...
            case 'update':
                ...
                if ($cat_id > 0 && !empty($cat_name)) {
                    $message = "Category ID $cat_id would be updated to '$cat_name'! (Test mode)";
                } else {
        ...
        <div class="card-body">
            <form method="get" class="form-inline">
                ...
                <?php if (!empty($search_term) || $show_all): ?>
                    <a href="<?php echo BASE_URL; ?>/view/admin/categories_test.php" class="btn btn-outline">
